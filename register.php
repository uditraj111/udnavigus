...
<form name="myform" method="post" onsubmit="javascript:return validate('myform','name','pwd','email','mob')">
...
<tr><th>User Name</th><td><input type="text" name="name" placeholder="Enter user name" required /><span id="usererror"></span></td></tr>
...
<tr><th>Password</th><td><input type="text" name="pwd" placeholder="Enter your password" required ></input><span id="pwderror" class="text-danger font-weight-bold"></span></td><tr>

<tr><th>Email</th><td><input type="text" name="email" placeholder="Enter your email" required ></input><span id="emailerror" class="text-danger font-weight-bold"></span></td><tr>
  
  <tr><th>Your Profile</th><td><input type="file" name="image" value="image"/></td></tr>
